...
public class PlayerInteraction : MonoBehaviour
{
    ...
    {
        if (!GameStateManager.Instance.ShouldDetectInteractables())
        {
            // Se detecção desabilitada, limpar referência
    ...
    private void UpdateCurrentInteractable(Interactable newInteractable)
    {
        ...
        if (newInteractable != currentInteractable)
        {
            ...
            // Mostrar indicador do novo (SE PERMITIDO pelo GameState)
            if (newInteractable != null && GameStateManager.Instance.ShouldShowInteractionIndicators())
            {
    ...
    {
        // Atualizar visibilidade do indicador baseado no novo estado
        if (currentInteractable != null)
        {
            if (GameStateManager.Instance.ShouldShowInteractionIndicators())
            {
